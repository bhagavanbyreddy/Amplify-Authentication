...
class _CustomTextFormFieldState extends State<CustomTextFormField>
  ...
  Icon get suffixIcon => widget.suffixIcon;

  FormFieldSetter<String> get onSaved => widget.onSaved;
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: style ?? WidgetUtils.getRegularTextStyle(color: textColor),
      ...
      onFieldSubmitted: nextNode == null
          ? onSubmitted
          : (value) {
